...
| Implementing Group Policy | - [Administrative Templates (.admx) for Windows Server 2022 (Aug 21 release)](https://www.microsoft.com/en-us/download/details.aspx?id=104003) <br> - [Administrative Templates (.admx) for Windows 10 October 2020 Update (20H2)](https://www.microsoft.com/en-us/download/details.aspx?id=102157) <br> - [Administrative Template files (ADMX/ADML) and Office Customization Tool for Microsoft 365 Apps for enterprise, Office 2019, and Office 2016](https://www.microsoft.com/en-us/download/details.aspx?id=49030) |
